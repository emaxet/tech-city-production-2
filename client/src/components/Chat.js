...
class Chat extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      socket: io('http://techcity.herokuapp.com:8080', {query: `chatId=${this.props.location.pathname.split('/')[4]}&username=${this.props.username}&userImage=${this.props.userImage}`}),
      connections: [],
      messages: [],
      newMessage: '',
      initialLoad: false,
